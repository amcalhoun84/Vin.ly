...
namespace Vin.ly
{
    [Activity(Label = "Find Wine by Type")]
    public class WineType : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.WineType);
            ...
            button.Click += async (IntentSender, e) =>
            {
                try
                {
                    string url = "http://52.27.116.225:8000/api/user/" + _userName + "/wine/type/" + wineSearch.Text;
                    ...
                    JsonValue json = await FetchTypeAsync(url);
                    ...
                    if(trueCount <= 0)
                    {
                        Error.Text = "No Wine Matching That Type Found.";                        
                    }
        ...
        private async Task<JsonValue> FetchTypeAsync(string url)
        {
